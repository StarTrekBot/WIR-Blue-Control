...
//#include "battery_hal_esp32.h" // geändert für Arduino IDE
#include "keyboard_ble_hal_esp32.h"

//BleKeyboard bleKeyboard("OMOTE Keyboard", "CoretechR");
BleKeyboard bleKeyboard("Self Keyboard", "Home");  // geändert für Arduino WIR-Blue-Control
...
void init_keyboardBLE_HAL() {
  ...
  //get_battery_status_HAL(&battery_voltage, &battery_percentage, &battery_ischarging);  // geändert für Arduino WIR-Blue-Control
